...
# add load
taskset -c 0 /bin/ping -l 60000 -q -s 10 -f localhost &
taskset -c 1 /bin/ping -l 60000 -q -s 10 -f localhost &
taskset -c 2 /bin/ping -l 60000 -q -s 10 -f localhost &
taskset -c 3 /bin/ping -l 60000 -q -s 10 -f localhost &
